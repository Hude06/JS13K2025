  ...
  */
  ...
  ga.worldCamera = function (world, canvas) {
    var camera = {
      ...
      centerOver: function (sprite, easing = 0.1) {
        // Smoothly interpolate the camera's position toward the sprite
        this.x += ((sprite.x + sprite.halfWidth) - (this.width / 2) - this.x) * easing;
        this.y += ((sprite.y + sprite.halfHeight) - (this.height / 2) - this.y) * easing;
      }
    };
